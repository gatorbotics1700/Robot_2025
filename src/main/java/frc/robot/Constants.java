...
public class Constants {
    ...
    public static final Pose2d SHOOTING_L4_LEFT_OFFSET = new Pose2d(CENTER_TO_BUMPER_OFFSET + 0.0254 + 0.0254, -CENTER_TO_POST  /*-0.161925*/, new Rotation2d(0)); //offset from center of robot to where we want to line up with the april tag
    public static final Pose2d SHOOTING_L4_RIGHT_OFFSET = new Pose2d(CENTER_TO_BUMPER_OFFSET + 0.0254 + 0.0254, CENTER_TO_POST /*0.161925*/, new Rotation2d(0)); //offset from center of robot to where we want to line up with the april tag
