...
public class Constants {
    ...
    public static final Pose2d SHOOTING_L4_LEFT_OFFSET = new Pose2d(CENTER_TO_CHASSIS_OFFSET + 0.0809625 + 0.0254, -CENTER_TO_POST - 0.03175/*-0.161925*/, new Rotation2d(0)); //offset from center of robot to where we want to line up with the april tag
    public static final Pose2d SHOOTING_L4_RIGHT_OFFSET = new Pose2d(CENTER_TO_CHASSIS_OFFSET + 0.0809625 + 0.0254, CENTER_TO_POST - 0.03175/*0.161925*/, new Rotation2d(0)); //offset from center of robot to where we want to line up with the april tag
    ...
    public static final double CORAL_L4_SHOOTING_VOLTAGE = -12.6; //-11.2; //-10.2;//-11;//-8.0;//-8.1;//-7.8;
