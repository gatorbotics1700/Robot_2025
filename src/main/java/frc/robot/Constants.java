...
public class Constants {
    ...
    public static final Pose3d LIMELIGHT_OFFSETS = new Pose3d(0.347, 0.003175, 0.155, new Rotation3d(Math.toRadians(-2.0), Math.toRadians(-21.0), Math.toRadians(-2.0)));
    //TODO: actually measure offsets
    public static final Pose3d LIMELIGHT_2_OFFSETS = new Pose3d(0.347, 0.003175, 0.155, new Rotation3d(Math.toRadians(-2.0), Math.toRadians(-21.0), Math.toRadians(-2.0)));
