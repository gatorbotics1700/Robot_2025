...
public class CoordinateTransforms {
    ...
    public void calculateReefCoordsL4Red() {
        ...
        System.out.println("id8 Right: " + id8RightCoord);
        System.out.println("id8 Left: " + id8LeftCoord);
        System.out.println("id9 Right: " + id9RightCoord);
        System.out.println("id9 Left: " + id9LeftCoord);
        System.out.println("id10 Right: " + id10RightCoord);
        System.out.println("id10 Left: " + id10LeftCoord);
        System.out.println("id11 Right: " + id11RightCoord);
        System.out.println("id11 Left: " + id11LeftCoord);
        System.out.println("id6 Right: " + id6RightCoord);
        System.out.println("id6 Left: " + id6LeftCoord);
    ...
    public void calculateReefCoordsL4Blue() {
        ...
        System.out.println("id21 Right: " + id21RightCoord);
        System.out.println("id21 Left: " + id21LeftCoord);
        System.out.println("id20 Right: " + id20RightCoord);
        System.out.println("id20 Left: " + id20LeftCoord);
        System.out.println("id19 Right: " + id19RightCoord);
        System.out.println("id19 Left: " + id19LeftCoord);
        System.out.println("id18 Right: " + id18RightCoord);
        System.out.println("id18 Left: " + id18LeftCoord);
        System.out.println("id17 Right: " + id17RightCoord);
